...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "rejseafregningssystem" because\n';
  ...
  $wnd.__gwt_activeModules['rejseafregningssystem'] = {
    'moduleName' : 'rejseafregningssystem',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/rejseafregningssystem.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['rejseafregningssystem'].superdevmode = true;

  var expectedSuffix = '/rejseafregningssystem.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + rejseafregningssystem + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:rejseafregningssystem';
  var devModeSessionKey = '__gwtDevModeSession:rejseafregningssystem';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/rejseafregningssystem/rejseafregningssystem.nocache.js';
  ...
  $wnd.__gwt_activeModules['rejseafregningssystem'].canRedirect = true;
  $wnd.__gwt_activeModules['rejseafregningssystem'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING rejseafregningssystem';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/rejseafregningssystem?user.agent=' + ua + '&_callback=' + callback;
